...
// user ads:
static ads1115_t *ads_cfg1;
static ads1115_t *ads_cfg2;
...
/*
 *input: 1 or 2 for two choices of ads
 */
void set_active_ads(unsigned short ads_number){
  ads_cfg=ads_number>1?ads_cfg2:ads_cfg1;
}

void initiate_two_ads(ads1115_t *ads_config1, ads1115_t *ads_config2){
  ADS1115_initiate(ads_config1);
  ads_cfg1=ads_cfg;
  ADS1115_initiate(ads_config2);
  ads_cfg2=ads_cfg;
}
